...
namespace Gatos.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            {
                model.Password = Convert.ToBase64String(GoodHash(model.Password));
            }
        ...
        private static byte[] GoodHash(string data)
        {
            var algo = new Rfc2898DeriveBytes(data, 128);
            algo.IterationCount = 1 << 20;
